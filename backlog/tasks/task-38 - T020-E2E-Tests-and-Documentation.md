...
<!-- SECTION:NOTES:BEGIN -->
Created E2E tests (TestFullWorkflow, TestRecordingCapture, TestMultiLayerComposition, TestRegistryLayerFetch) and documentation (LAYER_AUTHORING.md, RECORDING.md). Updated QUICKSTART.md with layer build examples. PR #89: https://github.com/peregrinesummit/nanofuse/pull/89
<!-- SECTION:NOTES:END -->
