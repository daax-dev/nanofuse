...
echo "  GitHub Actions will build and push to ghcr.io/daax-dev/nanofuse/base:$new_version"
echo "  View workflow at: https://github.com/daax-dev/nanofuse/actions"
echo ""
echo "Users can pull with:"
echo "  nanofuse image pull ghcr.io/daax-dev/nanofuse/base:$new_version"
